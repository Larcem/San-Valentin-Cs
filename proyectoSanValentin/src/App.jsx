...
function App() {
    ...
    <main id="canvas" className="fondo w-screen h-screen bg-no-repeat bg-cover flex items-center justify-center bg-center ">
      {
        !valueSi ? (
          <div className="p-5">
            <h1 className="text-white font-bold text-5xl text-center border-4 border-black p-4 bg-gray-500 rounded-lg ">
  ¿Quieres ser mi San Valentín?
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 mt-10 gap-5 items-center">
              <button onClick={() => {
                ...
                jsConfetti.addConfetti({
                  emojis: ['😍', '🥰', '❤️', '😘'],
                  confettiShape: 'url(/kitty.png)',  // Ruta correcta a la imagen en public
                  emojiSize: 70,
                  confettiNumber: 80,
                });
          ...
          <div className="flex justify-center items-center flex-col space-y-10">
            <h1 className="text-white font-bold text-5xl text-center border-4 border-black p-4 bg-gray-500 rounded-lg ">Sabia que dirias que si ❤️!</h1>
